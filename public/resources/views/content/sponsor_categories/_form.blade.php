...
<div class="row g-3">
  ...
  <div class="col-md-6">
    <label class="form-label">{{ __('sponsor_category.orders') }}</label>
    <input type="number" name="orders" class="form-control" value="{{ old('orders', $isEdit ? $sponsorCategory->orders : '') }}" required>
  </div>
