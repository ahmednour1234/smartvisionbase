...
<div class="row g-3">
  ...
  <div class="col-md-6">
    ...
    @if($isEdit && $sponsor->image)
      <img src="{{ asset('public/'.$sponsor->image) }}" alt="image" class="mt-2" width="80">
    @endif
  </div>
  ...
  <div class="col-md-6">
    ...
    <div class="col-md-6">
    <label class="form-label">{{ __('sponsor.sort') }}</label>
    <input type="number" name="sort" class="form-control" value="{{ old('sort', $isEdit ? $sponsor->sort : '') }}">
  </div>
</div>
