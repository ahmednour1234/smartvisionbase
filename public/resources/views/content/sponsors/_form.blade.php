...
<div class="row g-3">
  ...
  <div class="col-md-6">
    <label class="form-label">{{ __('sponsor.link_profile') }}</label>
    <input type="text" name="link_profile" class="form-control" value="{{ old('link_profile', $isEdit ? $sponsor->link_profile : '') }}">
  </div>
  <div class="col-md-6">
   ...
   <div class="col-md-6">
    <label class="form-label">{{ __('sponsor.orders') }}</label>
    <input type="number" name="orders" class="form-control" value="{{ old('orders', $isEdit ? $sponsor->orders : '') }}" required>
  </div>
     <div class="col-md-6">
    <label class="form-label">{{ __('sponsor.link_profile') }}</label>
    <input type="url" name="link_profile" class="form-control" value="{{ old('link_profile', $isEdit ? $sponsor->link_profile : '') }}" >
  </div>
  ...
  <div class="col-md-6">
    ...
    <div class="col-md-6">
    <label class="form-label">{{ __('sponsor.email') }}</label>
    <input type="email" name="email" class="form-control" value="{{ old('email', $isEdit ? $sponsor->email : '') }}" required>
  </div>
  <div class="col-md-6">
    <label class="form-label">{{ __('sponsor.password') }}</label>
    <input type="password" name="password" class="form-control" value="{{ old('password', $isEdit ? $sponsor->password : '') }}" >
  </div>
