      ...
      <div class="row justify-content-center g-4">
        @foreach($multimedias as $media)
          ...
          @foreach($videos as $link)
            @php $embedUrl = $youtubeEmbed($link); @endphp
            @if($embedUrl)
          ...
          @foreach($multimedias as $media)
            ...
            @foreach($images as $image)
              ...
              <div class="col-md-4 col-lg-3 pt-4">
                <a href="#" class="popup-trigger d-block" data-bs-toggle="modal" data-bs-target="#imageModal" data-image="{{ $imgSrc }}">
                  <div class="image-wrapper rounded overflow-hidden">
                    <img src="{{ $imgSrc }}" class="img-fluid gallery-thumb" alt="image">
                  </div>
                </a>
              </div>
            @endforeach
