    ...
    <div class="parallax-content section-lg context-dark text-center" style="background-color:#fff;">
      ...
      <div class="row justify-content-center mt-3 mb-3 px-3">
        <div class="col-12 col-sm-10 col-md-6 search-container">
          <input type="text" class="form-control js-search" placeholder="{{ __('Search by name, description...') }}" autocomplete="off">
        </div>
      </div>
      -->

      <div class="js-no-results">{{ __('No results found') }}</div>
      ...
      <div class="mt-1">
        <button type="button" class="js-load-more">{{ __('Load More') }}</button>
        <div class="js-all-shown">{{ __('All items are shown') }}</div>
      </div>
    </div>
  </section>
</div>
  ...
  <div class="parallax-content section-lg context-dark text-center">
    ...
    <div class="js-wrapper">
      @foreach ($companies as $idx => $company)
        ...
        <div class="row justify-content-center company-row" data-search="{{ e($searchData) }}" data-index="{{ $idx }}">
          <div class="col-md-10">
            <div class="card mb-4 p-3 shadow company-card" data-aos="fade-up" data-aos-delay="100">
              <div class="row g-3 align-items-center company-card-inner">
                ...
                <div class="col-md-7 text-start">
                  <h4 class="mb-2 stat-number" style="font-size:35px;">{{ $company->name_en }}</h4>
                  @if($company->category)
                    <p class="fw-bold">{{ $company->category }}</p>
                  @endif
                </div>
