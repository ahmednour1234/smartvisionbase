...
Route::prefix('dashboard')->name('dashboard.')->group(function () {
    Route::resource('ads', \App\Http\Controllers\dashboard\AdController::class);
});
...
Route::prefix('admin')
  ...
  ->group(function () {
    Route::prefix('multi-medias')
     ...
     Route::delete('multi-medias/{multiMedia}', [
...
Route::delete('sponsors/delete-selected', [SponsorController::class, 'destroySelected'])
    ->name('admin.sponsors.destroySelected');
    Route::delete('speakers/delete-selected', [SpeakerController::class, 'destroySelected'])
    ->name('admin.speakers.destroySelected');
