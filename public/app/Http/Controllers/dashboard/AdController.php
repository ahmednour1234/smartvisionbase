...
class AdController extends Controller
{
    ...
    public function destroy(\App\Models\Ad $ad)
{
    if ($ad->attachment_path && file_exists(public_path($ad->attachment_path))) {
        @unlink(public_path($ad->attachment_path));
    }
    ...
    return redirect()
        ...
        ->with('success', __('ads_deleted_success'));
}
