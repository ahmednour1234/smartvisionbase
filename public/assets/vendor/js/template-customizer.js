...
var TemplateCustomizer = /*#__PURE__*/function () {
  ...
  return _createClass(TemplateCustomizer, [{
    ...
    value: function _setup() {
      ...
      if (this.settings.displayCustomizer) customizerW.setAttribute('style', 'visibility: hidden');else customizerW.setAttribute('style', 'visibility: hidden');
