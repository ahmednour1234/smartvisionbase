...
<section class="section section-lg bg-default text-center" style="background: #f5f5f5 ">
    <div class="container">
        <h4 class="font-weight-bold mb-4"><?php echo e($speaker_section->title[$locale] ?? ''); ?></h4>
        ...
        <div class="row">
            ...
            <?php $__currentLoopData = $speakers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $speaker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-6 col-md-6 col-lg-4 mb-4" id="speaker-<?php echo e($speaker->id); ?>">
                    <div class="speaker">
                        <div class="speaker-img">
                            <a href="#">
                                <img src="<?php echo e(asset('public/'.$speaker->image)); ?>"
                                    alt="<?php echo e($locale == 'ar' ? $speaker->name_ar : $speaker->name_en); ?>" />
                            </a>
                        </div>
                        <div class="speaker-info">
                            <h5 class="speaker-title">
                                <a href="#"><?php echo e($locale == 'ar' ? $speaker->name_ar : $speaker->name_en); ?></a>
                            </h5>
                            ...
                            <ul class="speaker-social-list">
                                <?php $__currentLoopData = $socialPlatforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(!empty($speaker->$field)): ?>
                                        <li>
                                            <a class="icon fa fa-<?php echo e($icon); ?>" href="<?php echo e($speaker->$field); ?>" target="_blank"
                    ...
                    <?php for($i = 1; $i <= $totalPages; $i++): ?>
                        <li>
                            <a href="<?php echo e(url()->current()); ?>?page=<?php echo e($i); ?>"
                                class="btn btn-sm <?php echo e($i == $page ? 'btn-primary text-white' : 'btn-light text-dark'); ?>">
                                <?php echo e($i); ?>
...
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u552947370/domains/affiliatesummitglobal.com/public_html/resources/views/web/content/speaker.blade.php ENDPATH**/ ?>