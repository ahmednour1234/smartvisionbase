...
<section class="section section-swiper-absoulte context-dark text-center">
    ...
    <div class="container">
      <div class="row justify-content-lg-center">
        <div class="col-lg-10 homecontent">
          ...
          <?php if($description): ?>
            <h4 class="text-spacing-200 mb-3"><?php echo e($description); ?></h4>
          <?php endif; ?>

          <?php if($title): ?>
            <h1 class="responsive-title fw-bold" style="letter-spacing:-.5px;"><?php echo e($title); ?></h1>
          <?php endif; ?>
          ...
          <ul class="list-inline list-inline-md mt-4">
              ...
              <div class="unit unit-spacing-xs align-items-center">
                <div class="unit-left line-height-reset">
                  <svg class="svg-icon-sm svg-icon-primary" role="img" aria-hidden="true">
                    <use xlink:href="<?php echo e(asset('public/web/assets/images/svg/sprite.svg#small-calendar')); ?>"></use>
                  </svg>
                </div>
                <div class="unit-body">
                  <h5 class="text-spacing-100 m-0">
                    <span class="big">
                      <time datetime="<?php echo e($event->event_date); ?>"><?php echo e($rangeText); ?><?php if($timeText): ?> | <?php echo e($timeText); ?> <?php endif; ?></time>
                    </span>
                  </h5>
                </div>
              </div>
            ...
            <li>
              <div class="unit unit-spacing-xs align-items-center">
                <div class="unit-left line-height-reset">
                  <svg class="svg-icon-sm svg-icon-primary" role="img" aria-hidden="true">
                    <use xlink:href="<?php echo e(asset('public/web/assets/images/svg/sprite.svg#earth-globe')); ?>"></use>
                  </svg>
                </div>
                <div class="unit-body">
                  <h5 class="text-spacing-100 m-0"><span class="big"><?php echo e($event->location ?? ''); ?></span></h5>
                </div>
              </div>
            </li>
          </ul>
  ...
  <div class="swiper-container swiper-slider swiper-slider-1" data-loop="true" data-simulate-touch="false" data-autoplay="8500" data-direction="horizontal" data-effect="fade">
    <div class="swiper-wrapper">
      <?php if($home_slider->media_type === 'image' && !empty($home_slider->media_path)): ?>
        <div class="swiper-slide with-dark-overlay" data-slide-bg="<?php echo e(asset('public/'.$home_slider->media_path)); ?>"></div>
        <noscript>
          <img src="<?php echo e(asset('public/'.$home_slider->media_path)); ?>" alt="hero" style="width:100%;height:auto;display:block;" loading="lazy" decoding="async" fetchpriority="low"/>
        </noscript>
      <?php elseif($home_slider->media_type === 'video' && !empty($home_slider->media_path)): ?>
        <div class="swiper-slide">
          <video autoplay muted loop playsinline preload="metadata" style="width:100%; height:min(100svh,100vh); object-fit:cover; display:block;">
            <source src="<?php echo e(asset('public/'.$home_slider->media_path)); ?>" type="video/mp4">
...
<?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <?php switch($section->id):
    case (2): ?>
      <?php echo $__env->make('web.content.sections.promo', ['section' => $section], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <?php break; ?>
    <?php case (3): ?>
      <?php echo $__env->make('web.content.sections.about', ['section' => $section, 'event' => $event], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <?php break; ?>
    <?php case (4): ?>
      <?php echo $__env->make('web.content.sections.speaker', ['section' => $section, 'speakers' => $speakers], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <?php break; ?>
    <?php case (5): ?>
      <?php echo $__env->make('web.content.sections.schedule', ['section' => $section, 'schedules' => $schedules], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <?php break; ?>
    <?php case (6): ?>
      <?php echo $__env->make('web.content.sections.floor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <?php echo $__env->make('web.content.sections.gallery', ['section' => $section, 'gallieries' => $gallieries], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <?php break; ?>
    <?php case (7): ?>
      <?php echo $__env->make('web.content.sections.sponsor', ['section' => $section, 'sponsors' => $sponsors], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <?php break; ?>
    <?php case (8): ?>
      <?php echo $__env->make('web.content.sections.blog', ['section' => $section, 'blogs' => $blogs], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <?php break; ?>
    <?php case (9): ?>
      <?php echo $__env->make('web.content.sections.promo2', ['section' => $section], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <?php break; ?>
    <?php case (10): ?>
      <?php if($sectionvote && $sectionvote->is_active==1): ?>
        <?php echo $__env->make('web.content.sections.voting', ['section' => $section], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <?php endif; ?>
      <?php break; ?>
    <?php case (11): ?>
      <?php
        ...
        <div class="container modern-stats-inner">
          <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="stat-card">
              ...
              <h3 class="stat-number" data-target="<?php echo e($stat['value']); ?>">0</h3>
      ...
      <?php echo $__env->make('web.content.sections.special', ['section' => $section, 'special_guests' => $special_guests], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <?php break; ?>
  <?php endswitch; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

<?php if (! $__env->hasRenderedOnce('81275c59-7180-462d-a049-d0a5f68d849d')): $__env->markAsRenderedOnce('81275c59-7180-462d-a049-d0a5f68d849d'); ?>
...
<script>
  document.addEventListener('DOMContentLoaded', function(){
    ...
    const payloadBase = {
      ...
      <?php if(!empty($testCode)): ?>
      test_event_code: '<?php echo e($testCode); ?>',
      <?php endif; ?>
    };
    ...
    <?php endif; ?>
    fetch('<?php echo e(url('/api/meta/capi')); ?>', {
      method: 'POST',
    ...
    <?php if($hasPixel): ?>
      try { fbq('track', 'ViewContent', {
        content_name: <?php echo json_encode($event->title[$locale] ?? ($event->title ?? 'Event'), 15, 512) ?>,
        content_type: 'event',
...
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u552947370/domains/affiliatesummitglobal.com/public_html/resources/views/web/content/home.blade.php ENDPATH**/ ?>