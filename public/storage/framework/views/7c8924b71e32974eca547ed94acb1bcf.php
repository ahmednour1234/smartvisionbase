...
<section id="home-promo" class="overflow-hidden" style="margin-top:-10px; background:#fff; position:relative; padding-bottom:30px;">
  <div class="container">
    ...
    <div class="media-wrap">
          ...
          (function(){
            ...
            window.addEventListener('load', function(){
              try {
                ...
                const src = <?php echo json_encode($mediaSrc, 15, 512) ?>;
      ...
      <?php elseif($section->media_type === 'image'): ?>
      ...
      <?php elseif($section->media_type === 'link' && $thumbSrc): ?>
        ...
        <div class="video-thumb-wrap" data-bs-toggle="modal" data-bs-target="#videoModal" aria-label="Play video">
          <div class="gradient-border">
            <img class="video-thumb-img"
                 src="<?php echo e($thumbSrc); ?>"
                 alt="Video Thumbnail"
                    loading="lazy" decoding="async" fetchpriority="low">
            <div class="yt-play">
              <div class="yt-btn" title="<?php echo e(__('تشغيل الفيديو')); ?>">
        ...
        <script>
          document.addEventListener('DOMContentLoaded', function () {
            ...
            const rawUrl = <?php echo json_encode($section->media_path, 15, 512) ?>;
...
<?php if (! $__env->hasRenderedOnce('b9b04371-34bc-4dcb-88e7-1c64fe414a18')): $__env->markAsRenderedOnce('b9b04371-34bc-4dcb-88e7-1c64fe414a18'); ?>
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>
<?php endif; ?>
<?php /**PATH /home/u552947370/domains/affiliatesummitglobal.com/public_html/resources/views/web/content/sections/promo2.blade.php ENDPATH**/ ?>