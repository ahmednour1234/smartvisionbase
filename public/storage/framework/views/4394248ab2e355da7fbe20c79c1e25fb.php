...
<nav class="layout-navbar <?php echo e($containerNav); ?> navbar navbar-expand-xl <?php echo e($navbarDetached); ?> align-items-center bg-navbar-theme" id="layout-navbar">
    ...
    <div class="<?php echo e($containerNav); ?>">
      ...
      <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
          ...
          <!--    <li>-->
          <!--      <a class="dropdown-item <?php echo e(app()->getLocale() === 'en' ? 'active' : ''); ?>" href="<?php echo e(url('lang/en')); ?>" data-language="en" data-text-direction="ltr">-->
          <!--        <span class="align-middle">English</span>-->
          <!--      </a>-->
          <!--    </li>-->
          <!--  <li>-->
          <!-- <a class="dropdown-item <?php echo e(app()->getLocale() === 'ar' ? 'active' : ''); ?>" href="<?php echo e(url('lang/ar')); ?>" data-language="ar" data-text-direction="rtl">-->
          <!--  <span class="align-middle">Arabic</span>              </a>-->
          <!--    </li>-->
          <!--  </ul>-->
          <!--</li>-->
          <!--/ Language -->
          ...
          <!--              <div class="avatar">-->
          <!--                <img src="<?php echo e(asset('assets/img/avatars/1.png')); ?>" alt class="h-auto rounded-circle">-->
          <!--              </div>-->
          <!--            </div>-->
          ...
          <!--            <div class="flex-shrink-0 me-3">-->
          <!--              <div class="avatar">-->
          <!--                <img src="<?php echo e(asset('assets/img/avatars/2.png')); ?>" alt class="h-auto rounded-circle">-->
          <!--              </div>-->
          <!--            </div>-->
          <!--            <div class="flex-grow-1">-->
          ...
          <!--            <div class="flex-shrink-0 me-3">-->
          <!--              <div class="avatar">-->
          <!--                <img src="<?php echo e(asset('assets/img/avatars/9.png')); ?>" alt class="h-auto rounded-circle">-->
          <!--              </div>-->
          <!--            </div>-->
          <!--            <div class="flex-grow-1">-->
          ...
          <!--            <div class="flex-shrink-0 me-3">-->
          <!--              <div class="avatar">-->
          <!--                <img src="<?php echo e(asset('assets/img/avatars/5.png')); ?>" alt class="h-auto rounded-circle">-->
          <!--              </div>-->
          <!--            </div>-->
          <!--            <div class="flex-grow-1">-->
          ...
          <!--            <div class="flex-shrink-0 me-3">-->
          <!--              <div class="avatar">-->
          <!--                <img src="<?php echo e(asset('assets/img/avatars/6.png')); ?>" alt class="h-auto rounded-circle">-->
          <!--              </div>-->
          <!--            </div>-->
          <!--            <div class="flex-grow-1">-->
  ...
  <!-- / Navbar -->
<?php /**PATH /home/u552947370/domains/affiliatesummitglobal.com/public_html/resources/views/layouts/sections/navbar/navbar.blade.php ENDPATH**/ ?>