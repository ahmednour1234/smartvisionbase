...
<section class="container-fluid section section-lg bg-default mt-5 mb-5">
  <div class="row">
    <div class="<?php echo e(!empty($ads) && count($ads) ? 'col-lg-8' : 'col-12'); ?> col-md-12">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 mb-4 mb-md-0">
            <h3><?php echo e($aboutSection->title[$locale] ?? ''); ?></h3>
            <p style="color:#000;"><?php echo e($aboutSection->description[$locale] ?? ''); ?></p>
          </div>
          <div class="col-md-6">
            <div class="img-separated">
              ...
              <?php if(($aboutSection->media_type ?? null) === 'image' && $aboutMedia): ?>
                <div class="skeleton-wrap" style="width:100%;max-width:100%;">
                  <img class="lazy-swap"
                       src="<?php echo e($placeholder); ?>"
                       data-src="<?php echo e($aboutMedia); ?>"
                       alt="About Image"
                       decoding="async"
                       fetchpriority="low"
                ...
                <noscript><img src="<?php echo e($aboutMedia); ?>" alt="About Image" class="img-fluid rounded shadow"></noscript>

              <?php elseif(($aboutSection->media_type ?? null) === 'video' && $aboutMedia): ?>
                
                <img id="aboutPoster" src="<?php echo e($thumb); ?>" alt="About Poster"
                     style="width:100%;height:auto;object-fit:cover;border-radius:8px;">
                <video id="aboutVideo" class="fade-in" playsinline muted loop preload="metadata"
                       poster="<?php echo e($thumb); ?>"
                      ...
                      const io = new IntersectionObserver((entries, obs) => {
                        entries.forEach(entry => {
                          if (entry.isIntersecting) {
                            const src = <?php echo json_encode($aboutMedia, 15, 512) ?>;
            ...
            <div class="ad-box mb-4 shadow-sm border rounded overflow-hidden">
              <a href="<?php echo e($ad->link ?? '#'); ?>" target="_blank" rel="noopener">
                <div class="skeleton-wrap" style="width:100%;max-height:300px;">
                  <img class="lazy-swap"
                       src="<?php echo e($placeholderAd); ?>"
                       <?php if($adImg): ?> data-src="<?php echo e($adImg); ?>" <?php endif; ?>
                       alt="Ad Image"
...
<?php if(isset($sec[4])): ?>
  <?php echo $__env->make('web.content.sections.speaker', ['section' => $sec[4], 'speakers' => $speakers], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
  ...
  <div class="container modern-stats-inner">
    <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="stat-card">
        ...
        <?php if(!empty($stat['suffix'])): ?> <span class="stat-suffix"><?php echo e($stat['suffix']); ?></span> <?php endif; ?>
...
<section class="section section-lg bg-default text-center">
  <div class="container">
    <h6><?php echo e($schdule_section->title[$locale] ?? ''); ?></h6>
    <h3 class="mt-3 gre-title"><?php echo e($schdule_section->description[$locale] ?? 'Event Agenda'); ?></h3>
        ...
        <?php $__currentLoopData = $groupedSchedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $daySchedules): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <li class="nav-item" role="presentation">
            <a class="nav-link <?php echo e($class); ?> <?php echo e($loop->first ? 'active' : ''); ?>"
               href="#<?php echo e($tabId); ?>" data-toggle="tab" role="tab" data-triangle=".nav-link-overlay">
              <span class="nav-link-overlay"></span>
              <span class="nav-link-cite"><?php echo e($dayLabel); ?></span>
              <span class="nav-link-title"><?php echo e(Carbon::parse($date)->translatedFormat('j F Y')); ?></span>
            </a>
          </li>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </ul>
                ...
                <article class="card card-custom card-corporate">
                  <div class="card-header" role="tab">
                    <div class="card-title">
                      <a class="collapsed" data-toggle="collapse" href="#collapse-<?php echo e($schedule->id); ?>" aria-expanded="false" role="button">
                          ...
                          <span class="unit unit-spacing-md align-items-center d-block d-md-flex">
                            <span class="unit-left">
                              <span class="schedule-classic-img skeleton-wrap" style="width:122px;height:122px;border-radius:8px;overflow:hidden;">
                                <img class="lazy-swap" src="<?php echo e($phLogo); ?>" <?php if($logo): ?> data-src="<?php echo e($logo); ?>" <?php endif; ?> alt="" width="122" height="122" style="object-fit:contain;border-radius:8px;">
                                <span class="skeleton-bg" aria-hidden="true"></span>
                                <span class="skeleton-shimmer" aria-hidden="true"></span>
                              </span>
                            </span>
                            <span class="unit-body">
                              <span class="schedule-classic-content">
                                <span class="schedule-classic-time">
                                  <?php echo e(Carbon::parse($schedule->start_datetime)->format('h:i A')); ?> to
                                  <?php echo e(Carbon::parse($schedule->end_datetime)->format('h:i A')); ?>

                                </span>
                                <span class="schedule-classic-title heading-4"><?php echo e($schedule->{'title_'.$locale}); ?></span>
                                <span class="schedule-classic-author" style="color:#000;"><?php echo e($schedule->{'description_'.$locale}); ?></span>
                              </span>
                            </span>
                          </span>
                        </span>
                  ...
                  <div class="collapse" id="collapse-<?php echo e($schedule->id); ?>">
                    <div class="card-body">
                      <p style="color:#000;"><?php echo e($schedule->{'description_'.$locale}); ?></p>
                      <div class="unit unit-spacing-xxs">
                        <div class="unit-left">
                          <svg class="svg-icon-sm svg-icon-primary" role="img">
                            <use xlink:href="<?php echo e(asset('public/images/svg/sprite.svg#earth-globe')); ?>"></use>
                          </svg>
                        </div>
                        <div class="unit-body">
                          <h5><?php echo e(__('Where')); ?></h5>
                          <p class="font-secondary"><?php echo e($schedule->{'location_'.$locale}); ?></p>
                        </div>
                      </div>
                    </div>
                  </div>
...
<?php if(isset($sec[7])): ?>
  <?php echo $__env->make('web.content.sections.sponsor', ['section' => $sec[7], 'sponsors' => $sponsors], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>


<?php if(isset($sec[6])): ?>
  <?php echo $__env->make('web.content.sections.gallery', ['section' => $sec[6], 'gallieries' => $gallieries], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>


<?php if(isset($sec[10]) && ($sec[10]->is_active ?? false)): ?>
  <?php echo $__env->make('web.content.sections.voting', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
...
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u552947370/domains/affiliatesummitglobal.com/public_html/resources/views/web/content/about.blade.php ENDPATH**/ ?>