  ...
  <div class="page-hero mb-3">
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
      ...
      <div class="toolbar d-flex gap-2">
        <a href="<?php echo e(route('dashboard.leads.export', request()->query())); ?>" class="btn btn-soft">
    ...
    <div class="card-body">
      <form class="row g-2 align-items-end" method="get">
        <div class="col-md-3">
          ...
          <input name="q" value="<?php echo e($filters['q'] ?? ''); ?>" class="form-control" placeholder="Search by name/email/phone/job">
        </div>
        ...
        <div class="col-md-2">
          ...
          <select name="status" class="form-select">
            ...
            <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($st); ?>" <?php if(($filters['status'] ?? '')===$st): echo 'selected'; endif; ?>><?php echo e(ucfirst(str_replace('_',' ', $st))); ?></option>
        ...
        <div class="col-md-3">
          ...
          <select name="assigned_user_id" class="form-select">
            ...
            <?php $__currentLoopData = $usersForFilters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <option value="<?php echo e($u->id); ?>" <?php if(($filters['assigned_user_id'] ?? '') == $u->id): echo 'selected'; endif; ?>><?php echo e($u->name); ?> <?php echo e($u->email ? "($u->email)" : ''); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
        </div>
        ...
        <div class="col-md-2 ms-auto d-flex gap-2">
          <a href="<?php echo e(request()->url()); ?>" class="btn btn-soft w-100"><i class="fa fa-rotate-left ic fa-fw"></i> Reset</a>
        ...
        <div class="stat-card p-3 h-100">
          <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center gap-2">
              <div class="avatar"><?php echo e(mb_substr($stat->name,0,1)); ?></div>
              <div>
                <div class="fw-semibold"><?php echo e($stat->name); ?></div>
                <div class="text-muted small">Total Leads: <?php echo e($stat->total_leads); ?></div>
              </div>
            </div>
            <div class="text-end small">
              <span class="badge bg-secondary me-1">New <?php echo e($stat->cnt_new); ?></span>
              <span class="badge bg-info text-dark me-1">F/U <?php echo e($stat->cnt_follow_up); ?></span>
              <span class="badge bg-success me-1">Acc <?php echo e($stat->cnt_accept); ?></span>
              <span class="badge bg-danger me-1">Rej <?php echo e($stat->cnt_reject); ?></span>
              <span class="badge bg-dark me-1">Lost <?php echo e($stat->cnt_lost); ?></span>
              <span class="badge bg-primary me-1"><i class="fa fa-comment ic fa-fw me-1"></i><?php echo e($stat->comments_count ?? 0); ?></span>
              <span class="badge bg-warning text-dark"><i class="fa fa-phone ic fa-fw me-1"></i><?php echo e($stat->calllogs_count ?? 0); ?></span>
            </div>
          </div>
        </div>
      </div>
  ...
  <?php if($leads->count()): ?>
    <div class="row g-3">
      <?php $__currentLoopData = $leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-12 col-md-6 col-xl-4">
          <div class="lead-card p-3 <?php echo e($isOverdue ? 'overdue' : ''); ?>">
            <div class="d-flex justify-content-between align-items-start mb-2">
              <span class="lead-chip <?php echo e($chipClass[$lead->status] ?? 'chip-new'); ?>">
                <i class="fa <?php echo e($iconMap[$lead->status] ?? 'fa-tag'); ?> ic fa-fw"></i>
              ...
              <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                  ...
                  <?php if(!$locked): ?>
                    ...
                    <li><hr class="dropdown-divider"></li>
                    <li>
                      <form action="<?php echo e(route('dashboard.leads.accept',$lead)); ?>" method="post">
                        <?php echo csrf_field(); ?>
                  ...
                  <?php else: ?>
                    <li>
                      <button class="dropdown-item" type="button" data-bs-toggle="modal" data-bs-target="#statusLocked<?php echo e($lead->id); ?>">
                  ...
                  <li><hr class="dropdown-divider"></li>
                  <li>
                    <form action="<?php echo e(route('dashboard.leads.destroy',$lead)); ?>" method="post" onsubmit="return confirm('Delete this lead?');">
            ...
            <div class="mb-2 small">
              ...
              <div>
                ...
                <?php if($waHref): ?>
                  <a href="<?php echo e($waHref); ?>" target="_blank" rel="noopener">
                    <?php echo e($rawPhone ?: '—'); ?>

                  </a>
                <?php elseif($telHref): ?>
                  <a href="tel:<?php echo e($telHref); ?>"><?php echo e($rawPhone ?: '—'); ?></a>
                <?php else: ?>
            ...
            <?php if($lead->status === 'accept' && $qrImgUrl): ?>
              <div class="mb-3">
                <button class="btn btn-soft w-100" data-bs-toggle="modal" data-bs-target="#qrForLead<?php echo e($lead->id); ?>">
            ...
            <div class="mb-2 small">
              <div class="mb-1 text-muted"><i class="fa fa-calendar-check ic fa-fw me-1"></i>
                Next follow-up:
                <span class="<?php echo e($isOverdue ? 'text-danger fw-semibold' : ''); ?>">
            ...
            <div class="mb-2 small text-muted">
              <i class="fa fa-user-tie ic fa-fw me-1"></i> Assigned to: <b><?php echo e($lead->assignedUser?->name ?? 'Unassigned'); ?></b>
              <?php if(Schema::hasColumn((new \App\Models\Lead)->getTable(), 'assigned_at') && $lead->assigned_at): ?>
                <span class="ms-2"><i class="fa fa-clock ic fa-fw me-1"></i><?php echo e(\Carbon\Carbon::parse($lead->assigned_at)->format('Y-m-d H:i')); ?></span>
              <?php endif; ?>
            </div>

            <div class="mb-3">
              <div class="text-muted small mb-1"><i class="fa fa-comment ic fa-fw me-1"></i> Latest Comment</div>
              <div class="text-trim-2"><?php echo e(optional($lead->comments->first())->comment ?? '—'); ?></div>
            </div>

            <div class="d-flex justify-content-between align-items-center">
              <div class="small text-muted">
                <i class="fa fa-id-badge ic fa-fw me-1"></i> #<?php echo e($lead->id); ?>

              </div>
              <div class="d-flex gap-2">
                <?php if($waHref): ?>
                  <a class="btn-icon" href="<?php echo e($waHref); ?>" target="_blank" rel="noopener" title="WhatsApp">
                    <i class="fa-brands fa-whatsapp ic fa-fw"></i>
                  </a>
                <?php endif; ?>
                <?php if($lead->status === 'accept' && $qrImgUrl): ?>
                  <button class="btn-icon" data-bs-toggle="modal" data-bs-target="#qrForLead<?php echo e($lead->id); ?>" title="QR Code">
                    <i class="fa fa-qrcode ic fa-fw"></i>
                  </button>
                <?php endif; ?>
                <a class="btn-icon" href="<?php echo e(route('dashboard.leads.show',$lead)); ?>" title="View">
                  <i class="fa fa-eye ic fa-fw"></i>
                </a>
                <button class="btn-icon" data-bs-toggle="offcanvas" data-bs-target="#offcanvasComment<?php echo e($lead->id); ?>" title="Comment">
                  <i class="fa fa-comment-dots ic fa-fw"></i>
                </button>
                <button class="btn-icon" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCall<?php echo e($lead->id); ?>" title="Log Call">
                  <i class="fa fa-phone ic fa-fw"></i>
                </button>
                <button class="btn-icon" data-bs-toggle="offcanvas" data-bs-target="#offcanvasEdit<?php echo e($lead->id); ?>" title="Edit">
        ...
        <div class="offcanvas offcanvas-end offcanvas-card" tabindex="-1" id="offcanvasAssign<?php echo e($lead->id); ?>" aria-labelledby="offcanvasAssignLabel<?php echo e($lead->id); ?>">
          <div class="offcanvas-header">
            <h5 id="offcanvasAssignLabel<?php echo e($lead->id); ?>">Assign Lead — <?php echo e($lead->name); ?></h5>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas"></button>
          </div>
          <div class="offcanvas-body">
            <div class="card">
              <div class="card-body">
                <form method="post" action="<?php echo e(route('dashboard.leads.assign',$lead)); ?>">
                  <?php echo csrf_field(); ?>
                  <label class="form-label">Select Agent</label>
                  <select class="form-select mb-3" name="assigned_user_id" required>
                    <option value="" disabled selected>Choose...</option>
                    <?php $__currentLoopData = $usersForFilters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value="<?php echo e($u->id); ?>" <?php if($lead->assigned_user_id == $u->id): echo 'selected'; endif; ?>><?php echo e($u->name); ?> <?php echo e($u->email ? "($u->email)" : ''); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                  <div class="text-end">
        ...
        <div class="offcanvas offcanvas-end offcanvas-card" tabindex="-1" id="offcanvasComment<?php echo e($lead->id); ?>" aria-labelledby="offcanvasCommentLabel<?php echo e($lead->id); ?>">
          <div class="offcanvas-header">
            <h5 id="offcanvasCommentLabel<?php echo e($lead->id); ?>">Comment on <?php echo e($lead->name); ?></h5>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas"></button>
          </div>
          <div class="offcanvas-body">
            <div class="card">
        ...
        <div class="offcanvas offcanvas-end offcanvas-card" tabindex="-1" id="offcanvasCall<?php echo e($lead->id); ?>" aria-labelledby="offcanvasCallLabel<?php echo e($lead->id); ?>">
          <div class="offcanvas-header">
            <h5 id="offcanvasCallLabel<?php echo e($lead->id); ?>">Log Call — <?php echo e($lead->name); ?></h5>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas"></button>
          </div>
          <div class="offcanvas-body">
            <div class="card">
              <div class="card-body">
                <?php $locked = in_array($lead->status,['accept','reject']); ?>
                <?php if($locked): ?>
                  <div class="alert alert-light border d-flex align-items-center" role="alert" style="border-radius:14px">
                    ...
                    <div>Status is final (<b><?php echo e(ucfirst(str_replace('_',' ',$lead->status))); ?></b>) — logging a call will not change the status.</div>
                  </div>
                <?php else: ?>
        ...
        <div class="offcanvas offcanvas-end offcanvas-card" tabindex="-1" id="offcanvasEdit<?php echo e($lead->id); ?>" aria-labelledby="offcanvasEditLabel<?php echo e($lead->id); ?>">
          <div class="offcanvas-header">
            <h5 id="offcanvasEditLabel<?php echo e($lead->id); ?>">Edit Lead</h5>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas"></button>
          </div>
          <div class="offcanvas-body">
            <div class="card">
              <div class="card-body">
                ...
                <?php if($locked): ?>
                  <div class="alert alert-light border d-flex align-items-center" role="alert" style="border-radius:14px">
                    <i class="fa fa-lock ic fa-fw me-2"></i>
                    <div>Status is final (<b><?php echo e(ucfirst(str_replace('_',' ',$lead->status))); ?></b>) — it cannot be changed here.</div>
                  </div>
                <?php endif; ?>
                <form method="post" action="<?php echo e(route('dashboard.leads.update',$lead)); ?>" class="js-phone-joiner">
                  <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                  <input type="hidden" name="phone" value="<?php echo e($rawPhone); ?>">
                  <div class="row g-2">
                    <div class="col-12">
                      <label class="form-label">Name</label>
                      <input name="name" value="<?php echo e($lead->name); ?>" class="form-control" required>
                    </div>
                    <div class="col-6">
                      <label class="form-label">Email</label>
                      <input name="email" value="<?php echo e($lead->email); ?>" class="form-control" placeholder="email">
                    </div>
                    <div class="col-6">
                      <label class="form-label">Phone</label>
                      <div class="input-group">
                        <input type="text" class="form-control" name="country_code_ui" value="<?php echo e($ccPrefill); ?>" placeholder="+20 أو 20" style="max-width:110px">
                        <input type="text" class="form-control" name="local_phone_ui" value="<?php echo e($localPrefill); ?>" placeholder="123456789">
                      </div>
                      <div class="form-text">سيتم ضم الحقلين وإرسالهما في مفتاح <code>phone</code> كما كُتبا (بـ + أو بدون +).</div>
                    </div>
                    <div class="col-12">
                      <label class="form-label">Job</label>
                      <input name="job" value="<?php echo e($lead->job); ?>" class="form-control" placeholder="job">
                    </div>
                    <div class="col-12">
                      <label class="form-label">Status</label>
                      <select name="status" class="form-select" <?php echo e($locked ? 'disabled' : ''); ?>>
                        <?php $__currentLoopData = ['new','follow_up','accept','reject','lost']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($st); ?>" <?php if($lead->status==$st): echo 'selected'; endif; ?>><?php echo e(ucfirst(str_replace('_',' ',$st))); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      </select>
                      <?php if($locked): ?>
                    ...
                    <div class="col-12">
                      ...
                      <input name="source" value="<?php echo e($lead->source); ?>" class="form-control" placeholder="source">
                    </div>
                    <div class="col-12">
                      <label class="form-label">Notes</label>
                    ...
                    <div class="col-12">
                      <label class="form-label small text-muted">Next follow-up</label>
                      <input type="datetime-local" name="next_call_at" class="form-control" value="<?php echo e($lead->next_call_at ? \Carbon\Carbon::parse($lead->next_call_at)->format('Y-m-d\TH:i') : ''); ?>">
                    </div>
                  </div>
                  <div class="text-end mt-3">
        ...
        <div class="modal fade" id="statusLocked<?php echo e($lead->id); ?>" tabindex="-1" aria-labelledby="statusLockedLabel<?php echo e($lead->id); ?>" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="border-radius:20px; border:1px solid var(--card-border);">
              <div class="modal-header">
                <h6 id="statusLockedLabel<?php echo e($lead->id); ?>" class="mb-0">
                  <i class="fa fa-lock ic fa-fw me-1"></i> Status is final
                </h6>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
              </div>
              <div class="modal-body">
                This lead status is <strong><?php echo e(ucfirst(str_replace('_',' ',$lead->status))); ?></strong>, so
        ...
        <?php if($lead->status === 'accept' && $qrImgUrl): ?>
          <div class="modal fade" id="qrForLead<?php echo e($lead->id); ?>" tabindex="-1" aria-labelledby="qrForLeadLabel<?php echo e($lead->id); ?>" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content" style="border-radius:20px; border:1px solid var(--card-border);">
                <div class="modal-header">
                  <h5 class="modal-title" id="qrForLeadLabel<?php echo e($lead->id); ?>">
                    <i class="fa fa-qrcode me-2"></i> QR Code — <?php echo e($lead->name); ?>

                  </h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body text-center">
                  <img src="<?php echo e($qrImgUrl); ?>" alt="QR" class="qr-img img-fluid">
                </div>
                <div class="modal-footer d-flex justify-content-between">
                  <a href="<?php echo e($qrImgUrl); ?>" target="_blank" class="btn btn-soft">
                    <i class="fa fa-up-right-from-square ic fa-fw"></i> Open
                  </a>
                  <a href="<?php echo e($qrImgUrl); ?>" download class="btn btn-dark">
    ...
    <div class="pagination-wrap">
      <div class="text-muted small">
        Showing <?php echo e($from); ?>–<?php echo e($to); ?> of <?php echo e($total); ?>

      </div>
      <ul class="pagination">
        <li class="<?php echo e($current == 1 ? 'disabled' : ''); ?>">
          <a class="page-link" href="<?php echo e($urlFirst); ?>" title="First">
            <i class="fa fa-angles-left"></i>
          </a>
        </li>
        <li class="<?php echo e($current == 1 ? 'disabled' : ''); ?>">
          <a class="page-link" href="<?php echo e($urlPrev); ?>" title="Previous">
            <i class="fa fa-angle-left"></i>
          </a>
        </li>

        <?php if($start > 1): ?>
          <li><a class="page-link" href="<?php echo e($pageUrl(1)); ?>">1</a></li>
          <?php if($start > 2): ?>
        ...
        <?php for($i = $start; $i <= $end; $i++): ?>
          <li class="<?php echo e($i == $current ? 'active' : ''); ?>">
        ...
        <?php if($end < $last): ?>
          <?php if($end < $last - 1): ?>
            <li class="disabled"><span class="page-link">…</span></li>
          <?php endif; ?>
          <li><a class="page-link" href="<?php echo e($pageUrl($last)); ?>"><?php echo e($last); ?></a></li>
        <?php endif; ?>

        <li class="<?php echo e($current == $last ? 'disabled' : ''); ?>">
          <a class="page-link" href="<?php echo e($urlNext); ?>" title="Next">
            <i class="fa fa-angle-right"></i>
          </a>
        </li>
        <li class="<?php echo e($current == $last ? 'disabled' : ''); ?>">
          <a class="page-link" href="<?php echo e($urlLast); ?>" title="Last">
...
<div class="offcanvas offcanvas-end offcanvas-card" tabindex="-1" id="offcanvasCreate" aria-labelledby="offcanvasCreateLabel">
  ...
  <div class="offcanvas-body">
    <div class="card">
      <div class="card-body">
        <form method="post" action="<?php echo e(route('dashboard.leads.store')); ?>" class="js-phone-joiner">
          <?php echo csrf_field(); ?>
          ...
          <div class="row g-2">
            ...
            <div class="col-12">
              ...
              <select name="status" class="form-select">
                <?php $__currentLoopData = ['new','follow_up','accept','reject','lost']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($st); ?>"><?php echo e(ucfirst(str_replace('_',' ',$st))); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
            </div>
            <div class="col-12">
...
<div class="offcanvas offcanvas-end offcanvas-card" tabindex="-1" id="offcanvasImport" aria-labelledby="offcanvasImportLabel">
  ...
  <div class="offcanvas-body">
    <div class="card">
      <div class="card-body">
        <form method="post" action="<?php echo e(route('dashboard.leads.import')); ?>" enctype="multipart/form-data">
          <?php echo csrf_field(); ?>
...
<?php if(session('qr_popup')): ?>
  <?php $qr = session('qr_popup'); ?>
      ...
      <div class="modal-content" style="border-radius:20px; border:1px solid var(--card-border);">
        <div class="modal-header">
          <h5 class="modal-title" id="qrPopupLabel">
            <i class="fa fa-qrcode me-2"></i> QR Code — <?php echo e($qr['lead_name'] ?? 'Accepted Lead'); ?>

          </h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body text-center">
          <?php if(!empty($qr['qr_image_url'])): ?>
            <img src="<?php echo e($qr['qr_image_url']); ?>" alt="QR" class="qr-img img-fluid">
          <?php endif; ?>
          <div class="small text-muted mb-2">
            Short code: <code><?php echo e($qr['short_code'] ?? ''); ?></code>
          </div>
          <?php if(!empty($qr['qr_image_url'])): ?>
            <div class="mb-3">
              <a href="<?php echo e($qr['qr_image_url']); ?>" target="_blank" class="small"><?php echo e($qr['qr_url']); ?></a>
            </div>
          <?php endif; ?>
        </div>
...
<?php echo $__env->make('layouts.layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u552947370/domains/affiliatesummitglobal.com/public_html/resources/views/content/customer/index.blade.php ENDPATH**/ ?>