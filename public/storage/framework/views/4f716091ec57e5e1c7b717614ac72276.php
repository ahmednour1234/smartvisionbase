...
<section class="breadcrumbs-custom bg-image context-dark"
  ...
  <div class="container">
    <h3 class="breadcrumbs-custom-title  pt-5">
      <?php echo e(($section ?? '') == 'aps' ? 'IBS & Affiliate' : 'Special Guest'); ?>
  ...
  <div class="container">
    ...
    <div class="search-row mt-4 mb-3">
      <div class="search-toolbar">
        <input id="q" type="text" placeholder="<?php echo e(__('Search by name or title...')); ?>" value="<?php echo e(e($q ?? '')); ?>">
        <button id="clearBtn" class="clear-btn" type="button"><?php echo e(__('Clear')); ?></button>
      </div>
    </div>

    <div id="speakersGrid" class="row mt-3">
      <?php echo $__env->make('web.content.partials._cards_special', [
        'speakers'        => $speakers,
    ...
    <div id="noResults" class="no-results <?php echo e($speakers->count() ? '' : 'show'); ?>"><?php echo e(__('No results found.')); ?></div>

    <div id="infiniteLoader" class="infinite-loader">
      <div class="spinner" aria-hidden="true"></div>
      <span><?php echo e(__('Loading more...')); ?></span>
    </div>

    <div id="infiniteSentinel" data-next-url="<?php echo e($speakers->nextPageUrl()); ?>" style="height:1px;"></div>
  </div>
</section>
...
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u552947370/domains/affiliatesummitglobal.com/public_html/resources/views/web/content/special.blade.php ENDPATH**/ ?>