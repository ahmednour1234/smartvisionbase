  ...
  <div class="parallax-content section-lg context-dark text-center">
    <div class="container">
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4">
            <div class="speaker">
              <div class="speaker-img">
                <a href="#" tabindex="-1" aria-label="<?php echo e($alt); ?>">
                  <img
                    class="speaker-photo"
              ...
              <div class="speaker-info">
                ...
                <p class="speaker-position">
                  <?php echo e($locale == 'ar' ? $speaker->title_en : $speaker->title_en); ?>
                ...
                <ul class="speaker-social-list" aria-label="Social links">
                  <?php $__currentLoopData = $socialPlatforms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(!empty($speaker->$field)): ?>
                      <li>
                        <a class="icon fa fa-<?php echo e($icon); ?>" href="<?php echo e($speaker->$field); ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php echo e(ucfirst($field)); ?>"></a>
                      </li>
                    <?php endif; ?>
      ...
      <a class="button button-secondary box-with-triangle-right wow fadeScale mt-4"
         href="<?php echo e(route('web.speaker')); ?>" data-triangle=".button-overlay">
        <span><?php echo e(__('home.view_all_speakers')); ?></span>
...
<?php endif; ?>
<?php /**PATH /home/u552947370/domains/affiliatesummitglobal.com/public_html/resources/views/web/content/sections/speaker.blade.php ENDPATH**/ ?>