...
<section class="parallax-container section mt-5" style="background:#f5f5f5;">
  ...
  <div class="parallax-content section-lg context-dark text-center">
    <div class="container">
      <h6 class="sub-tit"><?php echo e($section->title[$locale] ?? ''); ?></h6>
      <h3 class="gre-title" style="font-size:40px;font-weight:bolder;margin-top:15px">
        <?php echo e($section->description[$locale] ?? ''); ?>

      </h3>

      <div class="row mt-4">
        <?php $__currentLoopData = $special_guests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $speaker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4">
            <div class="speaker">
              ...
              <div class="speaker-img">
                <a href="#" tabindex="-1" aria-label="<?php echo e($altName); ?>">
                  <img
                    class="photo"
                    src="<?php echo e($imgReal); ?>"
                    alt="<?php echo e($altName); ?>"
                  ...
                  <div class="followers-inline" aria-label="Followers">
                    <?php if($hasIg): ?>
                      <span class="fi">
                        ...
                        <span>
                          <strong><?php echo e($followersIg); ?></strong>
                          <?php echo e(($locale ?? 'ar') === 'ar' ? ($igRaw == 1 ? 'متابع' : 'متابعين') : 'Followers'); ?>
                    ...
                    <?php if($hasTt): ?>
                      <span class="fi">
                        ...
                        <span>
                          <strong><?php echo e($followersTt); ?></strong>
                          <?php echo e(($locale ?? 'ar') === 'ar' ? ($ttRaw == 1 ? 'متابع' : 'متابعين') : 'Followers'); ?>
              ...
              <div class="speaker-info">
                <h5 class="speaker-title">
                  <a href="#">
                    ...
                    <?php if($flagUrl): ?>
                      <img class="country-flag" src="<?php echo e($flagUrl); ?>" alt="flag" loading="lazy" decoding="async" fetchpriority="low">
                    <?php endif; ?>
                  </a>
                </h5>

                <p class="speaker-position">
                  <?php echo e($locale == 'ar' ? ($speaker->title_ar ?? '') : ($speaker->title_en ?? '')); ?>
      ...
      <a class="button button-secondary box-with-triangle-right wow fadeScale mt-4"
         href="<?php echo e(route('web.special')); ?>" data-triangle=".button-overlay">
        <span><?php echo e($locale === 'ar' ? 'عرض جميع الضيوف المميزين' : 'View All Special Guests'); ?></span>
...
<?php endif; ?>
<?php /**PATH /home/u552947370/domains/affiliatesummitglobal.com/public_html/resources/views/web/content/sections/special.blade.php ENDPATH**/ ?>