...
<?php
    ...
    $mainImageUrl = 'https://affiliatesummitglobal.com/storage/app/public/' . ltrim($mainImage, '/');
...
<head>
  ...
  <style>
    ...
    #downloadBtn{
      ...
      background: <?php echo e($accent); ?>; color:#0b1a2b; font-weight:700;
...
<!-- Preheader -->
<div class="preheader">
  You're invited to <?php echo e($eventName); ?> on <?php echo e($formattedDate); ?> at <?php echo e($location); ?>.
</div>

<?php if($event->active_blade_email == 15 && !empty($event->text_email)): ?>
        ...
        <table role="presentation" width="680" cellpadding="0" cellspacing="0" border="0" style="width:680px; max-width:100%;">
          ...
          <tr>
            <td align="center" style="padding:6px 8px 28px;">
              <img src="<?php echo e($qrImageUrl); ?>" alt="QR Code" width="220" style="max-width:220px; height:auto; border-radius:10px;" crossorigin="anonymous">
...
<?php else: ?>
  ...
  <div class="hero">
    <img class="hero-img" src="<?php echo e($mainImageUrl); ?>" alt="Event main image" crossorigin="anonymous">
          ...
          <tr>
            <td style="padding:0 8px 12px;">
              <p style="margin:0 0 14px; font-size:18px; line-height:1.7; color:#111827;">
                Dear <?php echo e($client->name ?? 'Guest'); ?>,
              </p>
              ...
              <tr>
                <td style="padding:10px 0;">
                  <table role="presentation" width="680" cellpadding="0" cellspacing="0" border="0" style="width:680px; max-width:100%; background:#ffffff; border:1px solid #e9eef5; border-radius:14px; overflow:hidden;">
                    <tr>
                      <td style="padding:0;">
                        <img src="<?php echo e($blogImg); ?>" alt="Blog image" width="680" style="width:100%; height:auto;" crossorigin="anonymous">
                      </td>
                    </tr>
                    <tr>
                      <td style="padding:14px 16px 16px;">
                        <div style="font-size:13px; color:#6b7280; margin:0 0 4px;">
                          <span><?php echo e($blogName); ?></span> &middot; <time datetime="<?php echo e(optional($blog->created_at)->toDateString()); ?>"><?php echo e($blogDate); ?></time>
                        </div>
                        <h3 style="margin:0 0 8px; font-size:18px; line-height:1.4; color:#111827;">
                          <a  href="<?php echo e(route('web.blog.show',[$blog->id])); ?>" style="color:#111827; text-decoration:none;"><?php echo e($blogTitle); ?></a>
                        </h3>
            ...
            <td align="center" style="padding:16px;">
              <?php $__currentLoopData = $socials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(!empty($settings->$field)): ?>
                  <a href="<?php echo e($settings->$field); ?>" target="_blank" style="display:inline-block; margin:0 6px;">
                    <img src="<?php echo e($baseUrl . $icon); ?>" alt="<?php echo e($field); ?> icon" width="36" style="width:36px; height:36px;" crossorigin="anonymous">
                  </a>
                <?php endif; ?>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </td>
...
<?php /**PATH /home/u552947370/domains/affiliatesummitglobal.com/public_html/resources/views/emails/client/qr.blade.php ENDPATH**/ ?>