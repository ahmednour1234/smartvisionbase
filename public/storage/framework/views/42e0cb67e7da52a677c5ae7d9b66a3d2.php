      ...
      <div class="row justify-content-center mt-3 mb-3 px-3">
        <div class="col-12 col-sm-10 col-md-6 search-container">
          <input type="text" id="searchInput" class="form-control"
                 placeholder="<?php echo e(__('Search by name, description...')); ?>" autocomplete="off">
        </div>
      </div>
...
<?php /**PATH /home/u552947370/domains/affiliatesummitglobal.com/public_html/resources/views/web/content/partials/voting-mobile.blade.php ENDPATH**/ ?>