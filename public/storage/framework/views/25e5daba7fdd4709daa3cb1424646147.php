  ...
  <div class="container">
    <div class="contact-one__inner">
      ...
      <?php if(session('success')): ?>
        <div class="alert alert-success" role="alert" style="margin-bottom:18px"><?php echo e(session('success')); ?></div>
      <?php endif; ?>
      <?php if($errors->any()): ?>
      ...
      <form class="contact-one__form" action="<?php echo e(route('web.contact.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="row">
    ...
    <div class="row">
      ...
      <div class="col-xl-4 col-lg-4">
        <div class="contact-two__single">
          ...
          <p class="contact-two__text"><?php echo e($setting->address ?? ''); ?></p>
        </div>
      </div>
        ...
        <div class="contact-two__single">
          ...
          <p class="contact-two__text">
            <?php if(!empty($setting->email)): ?>
              <a href="mailto:<?php echo e($setting->email); ?>"><?php echo e($setting->email ?? 'info@affaliatesummit.com'); ?></a>
            <?php endif; ?>
          </p>
        </div>
      </div>
...
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u552947370/domains/affiliatesummitglobal.com/public_html/resources/views/web/content/contact.blade.php ENDPATH**/ ?>