...
<section class="verify-section">
  <div class="container">
    <div class="verify-wrap">
      ...
      <form method="POST" action="<?php echo e(route('web.register.verify')); ?>" >
        <?php echo csrf_field(); ?>
        ...
        <div class="otp-grid">
          <?php for($i=1;$i<=6;$i++): ?>
            <input
              ...
              class="otp-input" data-index="<?php echo e($i); ?>" aria-label="Digit <?php echo e($i); ?>" required>
          <?php endfor; ?>
        </div>
      ...
      <form id="resendForm" method="POST" action="<?php echo e(route('web.register.resend')); ?>" class="d-none">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="email" value="<?php echo e($email ?? ''); ?>">
      </form>
...
<?php echo $__env->make('web.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u552947370/domains/affiliatesummitglobal.com/public_html/resources/views/web/content/verify.blade.php ENDPATH**/ ?>