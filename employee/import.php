...
require_login();
$u = current_user();
if ($u['role'] !== 'staff') { http_response_code(403); include __DIR__ . '/../403.php'; exit; }
...
unset($_SESSION['employee_import_skipped'], $_SESSION['employee_import_failed']);
    ...
    if ($ext !== 'csv') {
      ...
      if (!$fh) {
        ...
        try {
          ...
          $_SESSION['employee_import_skipped'] = $skippedDetails;
          $_SESSION['employee_import_failed'] = $failedDetails;
...
<div class="container py-4">
  <div class="d-flex align-items-center justify-content-between mb-3">
    <h3 class="m-0">Import (My Leads)</h3>
