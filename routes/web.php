...
Route::prefix('dashboard')->name('dashboard.')->middleware(['auth'])->group(function () {
    Route::resource('luxury-members', \App\Http\Controllers\dashboard\LuxuryCommunityMemberController::class);
        ...
        Route::PATCH ('/{id}/activate', [ \App\Http\Controllers\dashboard\LuxuryCommunityMemberController::class, 'activate'])->name('dashboard.luxury-members.activate');
...
Route::get('/invitation/download', [InvitationController::class, 'download'])->name('invitation.download');
...
Route::middleware(['auth'])
    ...
    // web.php
Route::delete('/dashboard/companies/bulk-destroy', [\App\Http\Controllers\dashboard\CompanyController::class, 'bulkDestroy'])
    ->name('dashboard.companies.bulkDestroy');
