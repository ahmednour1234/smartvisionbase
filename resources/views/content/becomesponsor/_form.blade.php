...
<div class="row g-4">
  ...
  <div class="col-md-6">
    ...
    <input type="text" name="name" id="name" class="form-control" placeholder="{{ __('registrations.name') }}"
  ...
  <div class="col-md-6">
    ...
    <input type="email" name="email" id="email" class="form-control" placeholder="{{ __('registrations.email') }}"
  ...
  <div class="col-md-6">
    ...
    <input type="text" name="phone" id="phone" class="form-control" placeholder="{{ __('registrations.phone') }}"
  ...
  <div class="col-md-6">
    ...
    <input type="text" name="job" id="job" class="form-control" placeholder="{{ __('registrations.job') }}"
           value="{{ old('job', $isEdit ? $client->job : '') }}">
  </div>

  {{-- Company Name --}}
  <div class="col-md-6">
    <label for="company_name" class="form-label">{{ __('registrations.company_name') }}</label>
    <input type="text" name="company_name" id="company_name" class="form-control" placeholder="{{ __('registrations.company_name') }}"
  ...
  <div class="col-md-6">
    ...
    @if ($isEdit && $client->img)
      <div class="mt-2">
        <img src="{{ asset($client->img) }}" class="img-thumbnail shadow-sm border border-primary" width="120" alt="Client Image">
      </div>
    @endif
  </div>
