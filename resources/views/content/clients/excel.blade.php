  ...
  <div class="card-body">
    ...
    <div class="tab-content" id="excelTabsContent">
      ...
      <div class="tab-pane fade" id="upload" role="tabpanel">
        ...
        <form action="{{ route('dashboard.clients.import') }}" method="POST" enctype="multipart/form-data" class="mt-4">
          @csrf
...
<div class="col-md-6">
  <label class="form-label">{{ __('clients.select_event') }}</label>
  <select name="event_id" class="form-select" required>
    <option value="">{{ __('clients.choose_event') }}</option>
...
{{-- اختيار اللغة --}}
<div class="col-md-6">
  <label class="form-label">{{ __('clients.select_language') }}</label>
  <select name="lang" class="form-select" required>
    <option value="">{{ __('clients.choose_language') }}</option>
            ...
            <div class="col-md-12">
              <div class="form-check mt-2">
                ...
                <label class="form-check-label" for="send_email">
                  {{ __('clients.send_email_checkbox') }}
                </label>
              </div>
            </div>
          </div>
