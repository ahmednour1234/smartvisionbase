        ...
        <div class="col-sm-6 col-xl-6">
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-start justify-content-between">
                        <div class="content-left">
                            <span>{{ __('Regitration Today') }}</span>
                            <div class="d-flex align-items-center my-2">
                                <h3 class="mb-0 me-2">{{ $number_register_today }}</h3>
                            </div>
                            <p class="mb-0">{{ __('Today') }} {{ __('Regitration') }}</p>
                        </div>
                        <div class="avatar">
                            <span class="avatar-initial rounded bg-label-danger">
                                <i class="ti ti-user-plus ti-sm"></i>
  ...
  <div class="col-md-6">
    <div class="card shadow-sm">
      <div class="card-header bg-primary text-white">
        <h5 class="mb-0">{{ __('dashboard.latest_registration') }}</h5>
      </div>
      <div class="card-body p-0">
        <div class="table-responsive">
          <table class="table table-hover mb-0">
            ...
            <tbody>
              @forelse($latest_register as $client)
                <tr>
                  <td>{{ $loop->iteration }}</td>
                  <td>{{ $client->name }}</td>
                  <td>{{ $client->phone }}</td>
                  <td>
                    <a href="{{ route('dashboard.clients.show', $client->id) }}" class="btn btn-sm btn-outline-info">
                      {{ __('dashboard.view') }}
                    </a>
                  </td>
                </tr>
