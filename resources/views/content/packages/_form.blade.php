...
<div class="row gy-3">
  ...
  <!--<div class="col-md-6">-->
  <!--  <label class="form-label">{{ __('package.price_discount') }}</label>-->
  <!--  <input type="number" step="0.01" name="price_discount" class="form-control @error('price_discount') is-invalid @enderror"-->
