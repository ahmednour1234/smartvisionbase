...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
  ...
  <title>Smart Vision Summit Egypt</title>
  <meta charset="utf-8">
...
@php
    ...
    // لو event موجود و فيه event_date نعمل الفورمات
    $eventDate = null;

    if (!empty($event) && !empty($event->event_date)) {
        $eventDate = Carbon::parse($event->event_date)->format('Y-m-d H:i:s');
    }
@endphp
