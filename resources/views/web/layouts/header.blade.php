...
$about    = HomeSection::find(3);
$speakers = HomeSection::find(4);
$schdule  = HomeSection::find(5);
$sponsor  = HomeSection::find(7);
$blogs    = HomeSection::find(8);

$showAbout    = (bool) ($about?->is_active);
$showSpeakers = (bool) ($speakers?->is_active);
$showSchdule  = (bool) ($schdule?->is_active);
$showSponsor  = (bool) ($sponsor?->is_active);
$showBlogs    = (bool) ($blogs?->is_active);
              ...
              <a class="brand" href="{{ route('web.home') }}">
                ...
                @else
                  <img class="brand-logo-dark"  src="{{ asset('public/images/logo-default.png') }}"
                       srcset="{{ asset('public/images/logo-default@2x.png') }} 2x" alt="Logo" />
                  <img class="brand-logo-light" src="{{ asset('public/images/logo-inverse.png') }}"
          ...
          <div class="rd-navbar-main-element">
            <div class="rd-navbar-nav-wrap">
              <ul class="rd-navbar-nav">
                ...
                <!-- Blogs (كان داخل More — الآن عنصر مستقل ويظهر فقط إذا مفعّل) -->
                @if($showBlogs)
                ...
                <li class="rd-nav-item {{ request()->routeIs('web.contact') ? 'active' : '' }}">
                  <a class="rd-nav-link" href="{{ route('web.contact') }}">{{ __('Contact') }}</a>
                </li>
              </ul>
            </div>
          </div>

          <!-- RD Navbar Collapse: أزرار الحركة -->
