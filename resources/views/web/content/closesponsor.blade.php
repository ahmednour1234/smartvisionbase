...
<section class="breadcrumbs-custom bg-image context-dark"
    ...
    <div class="container text-center py-4">
        <h3 class="breadcrumbs-custom-title">CLOSED Become Sponsor</h3>
    </div>
</section>
<section class="notice-page">
  <div class="notice-wrap">
    ...
    <!-- العنوانين -->
    <h1 class="headline">Become Sponsor <span class="block">CLOSED</span></h1>
    <p class="subhead">NO ON-SITE Become Sponsor</p>
