...
<style>
    ...
    /* ========== VIDEO WRAPPER (وسط وارتفاع أقل) ========== */
    .video-wrapper {
        position: relative;
        width: 100%;
        max-width: 600px;       /* عرض متوسط */
        margin: 0 auto;         /* في النص */
        padding-top: 40%;       /* Aspect ratio أقل من 16:9 عشان الارتفاع يصغر */
        border-radius: 12px;
        overflow: hidden;
    ...
    .video-wrapper iframe {
        ...
        inset: 0;
        width: 100%;
        height: 100%;           /* مهم: ياخد طول الكونتينر كله */
        border: 0;
    }
    ...
    @media (max-width: 768px) {
        .video-wrapper {
            max-width: 100%;
            padding-top: 56.25%; /* في الموبايل رجّعناه 16:9 عشان يبقى مريح */
        }
    }
