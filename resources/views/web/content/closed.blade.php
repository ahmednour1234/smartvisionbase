...
<section class="notice-page">
  <div class="notice-wrap">
    ...
    <!-- نص صغير -->
<p class="copy" style="direction: rtl; text-align: right;">
  نودّ التنويه بأن التسجيل قد أُغلق، ولن يُسمح بالدخول إلا للحاصلين على دعوات تحتوي على رمز QR. لا يوجد تسجيل عند الوصول إلى موقع الفعالية.
</p>
