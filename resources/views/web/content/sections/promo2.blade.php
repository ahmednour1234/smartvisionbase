...
<section id="home-promo" class="overflow-hidden" style="margin-top:10px; background:#000; position:relative; margin-bottom:50px;">
  {{-- ✅ العنوان --}}
...
<style>
  /* زر التشغيل: أسود مع شفافية خفيفة جدًا */
  #home-promo .yt-btn{
    background: rgba(0,0,0,.9); /* تقريبًا معتم، شفافية بسيطة */
    box-shadow:
      0 12px 28px rgba(0,0,0,.28),
      0 2px 6px rgba(0,0,0,.18) inset,
      0 0 0 6px rgba(255,255,255,.12); /* هالة بيضا خفيفة */
  }
  #home-promo .yt-btn::after{
    /* نبض خفيف بلون أسود شبه شفاف بدل الأحمر */
    box-shadow: 0 0 0 0 rgba(0,0,0,.18);
  }
  #home-promo .yt-btn:hover{
