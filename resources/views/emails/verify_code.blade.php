...
@php $name = $client->name ?? 'Guest'; @endphp
<!DOCTYPE html>
<html lang="en">
          ...
          <table width="620" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;padding:24px;">
            <tr>
              <td align="left" style="font-family:Arial,Helvetica,sans-serif;color:#0f172a;">
                ...
                <p style="margin:0 0 16px;">Hi {{ $name }}, use the code below to verify your email:</p>
                <div style="font-size:28px; font-weight:700; letter-spacing:6px; padding:16px 0;">{{ $code }}</div>
                ...
                <p style="font-size:12px; color:#94a3b8;">© {{ date('Y') }} Forex Traders Summit</p>
              </td>
            </tr>
          </table>
        </td>
