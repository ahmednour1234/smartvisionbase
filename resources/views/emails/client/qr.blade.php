...
@php
    ...
    $mainImageUrl = 'https://toptrustedfxbrokers.com/storage/app/public/' . ltrim($mainImage, '/');
...
@if($event->active_blade_email == 1 && !empty($event->text_email))
          ...
          <tr>
            <td style="padding:0 8px 12px;">
              ...
              <p style="margin:0 0 12px; font-size:16px; line-height:1.75; color:#374151;">
                ...
                <strong>{{ $formattedDate }}</strong> at <strong>{{ $location }}</strong>.
              </p>
              <p style="margin:0 0 12px; font-size:16px; line-height:1.75; color:#374151;">
                Join industry leaders, marketers, and creatives as we explore what's next in event planning and digital engagement.
              </p>
              <p style="margin:0; font-size:16px; line-height:1.75; color:#374151;">
                Your invitation is personal. Please bring the QR code below for entry:
              </p>
            </td>
          </tr>
                    ...
                    <tr>
                      <td style="padding:14px 16px 16px;">
                        ...
                        <h3 style="margin:0 0 8px; font-size:18px; line-height:1.4; color:#111827;">
                          <a style="color:#111827; text-decoration:none;">{{ $blogTitle }}</a>
                        </h3>
...
<!-- مكتبة html2pdf (لا تحتاج باك إند) -->
